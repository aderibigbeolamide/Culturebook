            ...
            <div class="navigation-menu-body">
                <ul>
                   ...
                   <!--  <li <?php echo ($page == 'manage-updates') ? 'class="active"' : ''; ?>>
                    ...
                    <a class="pow_link" href="https://wa.me/2349161011118" target="_blank">
                        <p>Powered by</p>
                        <img src="https://www.finelib.com/images/listings/101804_company_logo.jpg">
                        <b class="badge">v1.0</b>
                    </a>
                </ul>
            </div>
        </div>
